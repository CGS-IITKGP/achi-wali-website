...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-foreground">
      ...
      <main className="min-h-screen flex items-center justify-center p-4 pt-24 pb-16 relative z-10">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="w-full max-w-md bg-gray-900 border border-gray-800 rounded-2xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl"
        >
          <div className="text-center mb-6">
            <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-pink-400 via-purple-400 to-fuchsia-400 bg-clip-text text-transparent mb-2">
              Game Credentials
            </h1>
          ...
          <div className="mb-6 p-4 rounded-xl bg-pink-500/10 border border-pink-500/20 text-pink-300 text-xs leading-relaxed">
