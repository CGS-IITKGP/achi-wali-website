                ...
                <div className="group h-full relative rounded-2xl bg-gradient-to-b from-gray-900/80 to-gray-950/90 border border-gray-800/50 hover:border-pink-500/40 overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-pink-500/10">
                    ...
                    <div className="relative p-6 flex flex-col items-center text-center h-full">
                        ...
                        <div className="relative mb-5">
                            <div className={`w-20 h-20 rounded-full bg-gradient-to-br ${avatarGradient} p-[2px] shadow-lg group-hover:shadow-xl group-hover:shadow-pink-500/20 transition-shadow duration-500`}>
                                <div className="w-full h-full rounded-full bg-gray-950 overflow-hidden relative">
                                    {user.profileImgMediaKey && !imgError ? (
                                        ...
                                        <div className={`w-full h-full flex items-center justify-center bg-gradient-to-br ${avatarGradient} text-2xl font-bold text-white select-none uppercase`}>
                                            {user.name.charAt(0)}
                                        </div>
                                    )}
                                </div>
                            ...
                            {/* Admin/Root badge */}
                            {isAdmin && (
                                <div className="absolute -bottom-1 -right-1 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full p-1.5 border-2 border-gray-950 shadow-lg" title="Admin">
