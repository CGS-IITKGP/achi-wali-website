    ...
    >
      <div className="mx-auto max-w-6xl px-6 py-10 md:px-10 md:py-14">
        ...
        <>
          ...
          <div className="rounded-xl border border-white/10 bg-white/[0.025] px-6 py-14 text-center text-white/50">
            Search for and select a game to view its leaderboard.
          </div>
        )}
      </div>
    </div>
