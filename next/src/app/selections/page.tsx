...
const portfolioData = {
  WebX: {
    ...
    welcomeContent: (
      <div className="space-y-4 text-gray-300 leading-relaxed text-sm sm:text-lg">
        ...
        <div className="mt-6 flex items-start gap-3 bg-pink-500/10 border border-pink-500/20 p-4 rounded-xl shadow-[0_0_15px_rgba(236,72,153,0.1)]">
    ...
    extraContent: (
      <div className="space-y-6">
        <h3 className="text-xl sm:text-2xl font-semibold text-pink-200 mb-4">Submission Guidelines</h3>
        
        <div className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5 sm:p-6">
          <h4 className="text-lg font-semibold text-pink-300 mb-3">1. GitHub Repository</h4>
        ...
        <div className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5 sm:p-6">
          <h4 className="text-lg font-semibold text-pink-300 mb-3">2. Code Structure & Build</h4>
          <ul className="list-disc pl-5 space-y-2 text-gray-300 text-sm sm:text-base">
        ...
        <div className="bg-pink-500/10 border border-pink-500/20 rounded-2xl p-5 sm:p-6 shadow-[0_0_15px_rgba(236,72,153,0.1)]">
          <h4 className="text-lg font-semibold text-pink-300 mb-3">Repo Checklist</h4>
          <ul className="list-disc pl-5 space-y-2 text-gray-300 text-sm sm:text-base mb-4">
        ...
        <div className="w-full h-px bg-pink-500/20 my-6"></div>
  ...
  Graphics: {
    ...
    extraContent: (
      <div className="space-y-6">
        ...
        <div className="mt-2 mb-6 flex items-start gap-3 bg-red-500/10 border border-red-500/20 p-5 rounded-xl shadow-[0_0_20px_rgba(239,68,68,0.15)]">
          <span className="text-2xl">🚨</span>
          <div className="text-red-200 text-sm sm:text-base leading-relaxed">
        ...
        <div className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5 sm:p-6">
          <h4 className="text-lg font-semibold text-pink-300 mb-3">1. Prepare Your Folder</h4>
          <p className="text-gray-400 text-sm mb-3">To submit your work successfully, prepare a folder containing:</p>
          <ul className="list-disc pl-5 space-y-2 text-gray-300 text-sm sm:text-base">
            ...
            <li className="text-pink-200 mt-3 border-l-2 border-pink-400 pl-3">
        ...
        <div className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5 sm:p-6">
          <h4 className="text-lg font-semibold text-pink-300 mb-3">2. Upload the Folder</h4>
          <ul className="list-disc pl-5 space-y-2 text-gray-300 text-sm sm:text-base">
  ...
  GameDev: {
    ...
    extraContent: (
      <div className="space-y-8">
        <div>
          <h3 className="text-xl sm:text-2xl font-semibold text-pink-200 mb-4">Evaluation Guidelines</h3>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-pink-500/5 border border-pink-500/10 rounded-xl p-4">
              <strong className="text-pink-300 block mb-1">1. Effort Over Complexity</strong>
              <span className="text-gray-300 text-sm">Prioritize effort over complexity. It&apos;s okay if your project is simple as long as you&apos;ve put in sincere effort.</span>
            </div>
            <div className="bg-pink-500/5 border border-pink-500/10 rounded-xl p-4">
              <strong className="text-pink-300 block mb-1">2. Presentation Matters</strong>
              <span className="text-gray-300 text-sm">Focus on presenting your game effectively. Ensure you understand every detail of your project and can explain how you created it.</span>
            </div>
            <div className="bg-pink-500/5 border border-pink-500/10 rounded-xl p-4">
              <strong className="text-pink-300 block mb-1">3. Exploration & Learning</strong>
              <span className="text-gray-300 text-sm">We appreciate your willingness to explore and learn. Share what components, code, and assets you&apos;ve explored.</span>
            </div>
            <div className="bg-pink-500/5 border border-pink-500/10 rounded-xl p-4">
              <strong className="text-pink-300 block mb-1">4. Task Preference</strong>
              <span className="text-gray-300 text-sm">Though we prefer creativity, a successful exhibition of theme-based Tasks would not be discriminated against.</span>
            </div>
          </div>
        </div>
        ...
        <div>
          <h3 className="text-xl sm:text-2xl font-semibold text-pink-200 mb-4">Submission Guidelines</h3>
          <p className="text-gray-400 text-sm mb-4">To have your game considered, please prepare and submit three essential components:</p>
          
          <div className="space-y-4 mb-6">
            <div className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5">
              <strong className="text-pink-300 text-lg block mb-2">1. Devlog</strong>
              <p className="text-gray-300 text-sm">Think of the Devlog as a diary for your game project. Introduce your game idea, maintain a record of your daily/weekly progress, and include challenges encountered (like bugs) and how you resolved them.</p>
            </div>
            <div className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5">
              <strong className="text-pink-300 text-lg block mb-2">2. Project Files</strong>
              <p className="text-gray-300 text-sm">This includes all the files in your project folder, with a focus on your assets, scenes, and scripts. These are the building blocks of your game.</p>
            </div>
            <div className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5">
              <strong className="text-pink-300 text-lg block mb-2">3. Final Build</strong>
              <p className="text-gray-300 text-sm">Compile your game into a playable file. Focus on creating a start-to-end Game Prototype with clear win/lose conditions.</p>
            </div>
            <div className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5 border-dashed">
              <strong className="text-pink-300 text-lg block mb-2">Optional Video (2-3 mins)</strong>
              <p className="text-gray-300 text-sm">Create a short video where you explain your game and discuss the scripts you&apos;ve used. Adds an extra layer of understanding to your submission.</p>
            </div>
          </div>

          <div className="bg-pink-500/10 border border-pink-500/20 rounded-2xl p-5 sm:p-6 shadow-[0_0_15px_rgba(236,72,153,0.1)]">
            <h4 className="text-lg font-semibold text-pink-300 mb-3">Important Submission Details</h4>
            <ul className="list-disc pl-5 space-y-2 text-gray-300 text-sm sm:text-base">
              ...
              <li className="text-pink-200 mt-4 border-l-2 border-pink-400 pl-3">
                <strong>Name your file:</strong> &lt;Your Name&gt;_&lt;Your Roll No&gt;_&lt;GameDev&gt;<br/>
                <span className="text-sm opacity-80 mt-1 block">Example: Sahil_25A110023_GameDev</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div>
          <h3 className="text-xl sm:text-2xl font-semibold text-pink-200 mb-4">Resources</h3>
          <p className="text-gray-400 text-sm mb-5">Here are some links to help you through your Game dev journey:</p>
          
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5">
              <strong className="text-pink-300 text-lg block mb-3">Documentation</strong>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li><a href="https://docs.unity3d.com/Manual/index.html" target="_blank" rel="noreferrer" className="text-pink-400 hover:underline">Unity Docs</a></li>
                <li><a href="https://docs.unrealengine.com/5.3/en-US/" target="_blank" rel="noreferrer" className="text-pink-400 hover:underline">Unreal Docs</a></li>
                <li><a href="https://docs.godotengine.org/en/stable/index.html" target="_blank" rel="noreferrer" className="text-pink-400 hover:underline">Godot Docs</a></li>
              </ul>
            </div>

            <div className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5">
              <strong className="text-pink-300 text-lg block mb-3">General Resources</strong>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li><a href="https://www.youtube.com/@Brackeys/featured" target="_blank" rel="noreferrer" className="text-pink-400 hover:underline">Brackeys</a></li>
                <li><a href="https://www.youtube.com/@SunnyValleyStudio/videos" target="_blank" rel="noreferrer" className="text-pink-400 hover:underline">Sunny Valley Studio</a></li>
                <li><a href="https://www.youtube.com/@CodeMonkeyUnity/featured" target="_blank" rel="noreferrer" className="text-pink-400 hover:underline">Code Monkey</a></li>
                <li><span className="text-pink-300">GMTK:</span> How I learned Unity without following tutorials</li>
              </ul>
            </div>
            
            <div className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5 sm:col-span-2">
              <strong className="text-pink-300 text-lg block mb-3">Assets</strong>
              <p className="text-gray-300 text-sm mb-3">You can try finding your desired assets on: Unity asset store/ unreal marketplace, Itch, Sketchfab, Ready Player Me, Vroid Studio.</p>
              <p className="text-gray-300 text-sm">
                <strong className="text-pink-300">Mixamo:</strong> <a href="https://www.youtube.com/watch?v=Q8lJpoUwaBA" target="_blank" rel="noreferrer" className="text-pink-400 hover:underline">Mixamo tutorial</a>
              </p>
            </div>
          </div>
        </div>
...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return <h3 className="text-xl sm:text-2xl font-semibold text-pink-200 mb-4">{children}</h3>;
}

function Paragraph({ children }: { children: React.ReactNode }) {
  return <p className="text-gray-300 leading-relaxed text-sm sm:text-lg mb-8 sm:mb-10">{children}</p>;
}
    ...
    <div className="mb-8">
      ...
      <ul className="space-y-3">
        {items.map((item, index) => (
          <li key={index} className="text-gray-300 leading-relaxed text-sm sm:text-base">
            •{" "}
            {typeof item === "object" && item.url ? (
              <a
                ...
                className="text-pink-400 hover:text-pink-300 hover:underline transition-colors duration-200"
              >
                {item.label}
              </a>
            ) : (
              // Fallback for standard string items (like Objectives, Phase 1, etc.)
              <span>{item}</span> 
            )}
          </li>
        ))}
        ...
        <div className="mb-8 sm:mb-10">
          ...
          <div className="space-y-6">
            {Object.entries(task.taskRequirements).map(([reqTitle, reqDesc]) => (
              <div key={reqTitle} className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5 sm:p-6">
                <h4 className="text-lg font-semibold text-pink-300 mb-2">{reqTitle}</h4>
                <p className="text-gray-300 text-sm sm:text-base leading-relaxed">{reqDesc as string}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {dynamicKeys.length > 0 && (
        <div className="space-y-6 mb-8 sm:mb-10">
          {dynamicKeys.map((key) => {
            ...
            return (
              <div key={key} className="bg-pink-500/5 border border-pink-500/10 rounded-2xl p-5 sm:p-6">
                <h4 className="text-lg font-semibold text-pink-300 mb-2 capitalize">
                  {displayTitle}
                </h4>
    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-[#12000f] to-black text-white pt-28 sm:pt-32 pb-40 sm:pb-32 px-4 sm:px-6 lg:px-8">
        ...
        <section className="max-w-6xl mx-auto text-center mb-12 sm:mb-16">
          <div className="inline-block mb-5 px-4 py-2 rounded-full border border-pink-500/30 bg-pink-500/10 text-pink-200 text-xs sm:text-sm shadow-[0_0_15px_rgba(236,72,153,0.15)]">
            2026–27 Selections
          </div>
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold text-pink-300 mb-5 leading-tight tracking-tight">
          ...
          {/* Deadline */}
          <div className="mt-8 max-w-2xl mx-auto border border-pink-500/20 bg-pink-500/5 rounded-2xl px-6 py-4 backdrop-blur-sm">
            <p className="text-pink-200 font-semibold text-sm sm:text-base">
              Submission Deadline:
              <span className="text-white ml-2">27th June 2026 • 11:59 PM (Tentative)</span>
            </p>
          </div>
        </section>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-[280px_1fr] gap-8 lg:gap-10">
          ...
          <div className="space-y-10 sm:space-y-16">
            ...
            <div className="relative overflow-hidden border border-pink-500/20 rounded-3xl p-6 sm:p-10 bg-gradient-to-br from-pink-500/10 via-transparent to-transparent backdrop-blur-md">
              {/* Decorative Blur Bubble */}
              <div className="absolute -top-24 -right-24 w-64 h-64 bg-pink-500/20 rounded-full blur-3xl pointer-events-none"></div>
              
              <h2 className="text-2xl sm:text-3xl font-bold text-pink-300 mb-4 drop-shadow-md">
            ...
            {currentPortfolio.tasks.map((task, index) => (
              <section
                id={`task-${index}`}
                key={index}
                className="scroll-mt-32 border border-pink-500/10 rounded-3xl p-5 sm:p-8 md:p-12 bg-white/[0.02] backdrop-blur-sm"
              >
                {/* Number & Title Header */}
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-pink-400 text-black flex items-center justify-center text-lg sm:text-xl font-bold mb-6 sm:mb-8 shadow-[0_0_15px_rgba(236,72,153,0.4)]">
                  {index + 1}
                </div>
            ...
            <section
              ...
              className="scroll-mt-32 border border-pink-500/20 rounded-3xl p-5 sm:p-8 md:p-12 bg-black/40 backdrop-blur-md shadow-[0_0_30px_rgba(236,72,153,0.05)] relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                <h2 className="text-3xl sm:text-4xl font-bold text-pink-300 mb-2 leading-tight">
                  Extra
                </h2>
                <div className="w-16 h-1 bg-pink-500/50 rounded-full mb-8"></div>
            ...
            <div className="flex justify-center pt-6 pb-20 sm:pb-6">
              <a
                ...
                download
                className="inline-flex items-center justify-center bg-pink-400 text-black font-semibold px-6 sm:px-7 py-3 sm:py-4 rounded-full hover:scale-105 hover:shadow-[0_0_20px_rgba(236,72,153,0.4)] transition-all duration-300 text-sm sm:text-base"
              >
        ...
        {showScrollTop && (
          <button
            ...
            className="fixed bottom-5 right-4 sm:bottom-7 sm:right-7 z-50 w-10 h-10 text-lg md:w-14 md:h-14 md:text-2xl rounded-full bg-pink-400 text-black flex items-center justify-center shadow-[0_0_15px_rgba(236,72,153,0.5)] hover:scale-110 transition-all duration-300 font-semibold"
          >
            ↑
          </button>
        )}
