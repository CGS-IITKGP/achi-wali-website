...
var ASM_CONSTS = {
  88574: () => { if (document.fullscreenElement) return 1; },  
 88620: () => { return Module.canvas.width; },  
 88652: () => { return parseInt(Module.canvas.style.width); },  
 88700: () => { document.exitFullscreen(); },  
 88727: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 88799: () => { if (document.fullscreenElement) return 1; },  
 88845: () => { return Module.canvas.width; },  
 88877: () => { return screen.width; },  
 88902: () => { document.exitFullscreen(); },  
 88929: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89123: () => { return window.innerWidth; },  
 89149: () => { return window.innerHeight; },  
 89176: () => { if (document.fullscreenElement) return 1; },  
 89222: () => { return Module.canvas.width; },  
 89254: () => { return parseInt(Module.canvas.style.width); },  
 89302: () => { if (document.fullscreenElement) return 1; },  
 89348: () => { return Module.canvas.width; },  
 89380: () => { return screen.width; },  
 89405: () => { return window.innerWidth; },  
 89431: () => { return window.innerHeight; },  
 89458: () => { if (document.fullscreenElement) return 1; },  
 89504: () => { return Module.canvas.width; },  
 89536: () => { return screen.width; },  
 89561: () => { document.exitFullscreen(); },  
 89588: () => { if (document.fullscreenElement) return 1; },  
 89634: () => { return Module.canvas.width; },  
 89666: () => { return parseInt(Module.canvas.style.width); },  
 89714: () => { document.exitFullscreen(); },  
 89741: ($0) => { Module.canvas.style.opacity = $0; },  
 89779: () => { return screen.width; },  
 89804: () => { return screen.height; },  
 89830: () => { return window.screenX; },  
 89857: () => { return window.screenY; },  
 89884: () => { return window.devicePixelRatio; },  
 89920: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 89973: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90024: () => { Module.canvas.style.cursor = 'none'; },  
 90061: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90317: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90368: () => { if (document.pointerLockElement) return 1; },  
 90415: () => { if (document.fullscreenElement) return 1; },  
 90461: () => { return window.innerWidth; },  
 90487: () => { return window.innerHeight; }
};
...
var _setBoidCount = Module['_setBoidCount'] = makeInvalidEarlyAccess('_setBoidCount');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['setBoidCount'] != 'undefined', 'missing Wasm export: setBoidCount');
  ...
  _setBoidCount = Module['_setBoidCount'] = createExportWrapper('setBoidCount', 1);
