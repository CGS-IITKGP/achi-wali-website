...
| `401 Unauthorized` | `INVALID_CREDENTIALS`, `INVALID_JWT`, `INVALID_OTP`, `UNAUTHORIZED`, `GOOGLE_OAUTH_FAILED` |
| `403 Forbidden` | `FORBIDDEN`, `NOT_TEAM_MEMBER` |
| `409 Conflict` | `EMAIL_TAKEN`, `TEAM_NAME_TAKEN`, `SLUG_ALREADY_IN_USE`, `ALREADY_FEATURED`, `MEDIA_PUBLIC_ID_ALREADY_EXISTS` |
